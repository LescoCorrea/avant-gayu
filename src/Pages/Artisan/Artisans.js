                                            ...
                                            <div className='prop'>
                                                <div className='avatar-prop'>
                                                    ...
                                                    <div className='coordonne mt-3'>
                                                        <div>
                                                            <h3 className=''><Link to="/voirartisan" className='atelier'>Wa keur Serigne Saliou</Link></h3>
                                        ...
                                        <div className="col-md-3 avatar">
                                            <div>
                                                <div className='avatar-prop'>
                                                    ...
                                                    <div className='coordonne mt-3'>
                                                        <div>
                                                            <h3 className=''><Link to="/voirartisan" className='atelier'>Atelier Mariama</Link></h3>
                                        ...
                                        <div className="col-md-3 avatar">
                                            <div>
                                                <div className='avatar-prop'>
                                                    ...
                                                    <div className='coordonne mt-3'>
                                                        <div>
                                                            <h3 className=''><Link to="/voirartisan" className='atelier'>Al Amsali Group</Link></h3>
